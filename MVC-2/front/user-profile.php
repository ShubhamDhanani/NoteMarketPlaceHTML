...
$user = $_SESSION['id'];
$s= mysqli_query($con,"select * from userprofile where UserID=$user");
...
if(isset($_POST['submit'])){
    ...
    $college= mysqli_real_escape_string($con,$_POST['college'] );
            ...
            if($lname!==$_SESSION['lname']){
                $updatelname = mysqli_query($con,"update users SET FirstName='$lname',ModifiedDate=CURRENT_TIMESTAMP() WHERE EmailID='$email'");
            }
    
        
    $select = "select * from userprofile Where UserID=$user";
