...
if(isset($_POST['submit'])){
    ...
    if($pass_decode){
        if($newpass==$cpass){
            ...
            $updatequery= "UPDATE users SET Password='$sec_pass' WHERE ID=$id";
                ...
                <form class="login-form" method="post" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="inputContainer">
                            <input type="password" id="old-password-field" class="form-control" placeholder="Password" name="oldpass">
                    ...
                    <div class="form-group">
                        ...
                        <div class="inputContainer">
                            <input type="password" id="new-password-field" class="form-control" placeholder="Password" name="newpass">
                    ...
                    <div class="form-group m-bottom-30">
                        ...
                        <div class="inputContainer">
                            <input type="password" id="confirm-password-field" class="form-control" placeholder="Password" name="cpass">
