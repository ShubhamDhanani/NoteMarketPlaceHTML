...
if(isset($_GET['edittype'])){
    ...
    $up = mysqli_query($con,"UPDATE notetypes SET IsActive=0,ModifiedDate=current_timestamp(),ModifiedBy=$mem where ID=$id");
...
<?php include '../php/front-header-admin.php'; ?>
    ...
    <section class="dashboard_table">
        <div class="container">
            <div class="row">
                <div class="heading col-md-6">Manage Type</div>
            </div>
            <br>
            <div class="row">
                <div class="admin_button col-md-4 col-sm-6 col-12">
                    <a href="add_type.php" style="text-decoration:none;"><button type="button" class="btn btn-primary admin_btn">Add Type</button></a>
                </div>
            ...
            <div class="row booktable table-responsive">
                <table class="table table-hover table-responsive table1">
                    ...
                    <tbody>
                        ...
                        $select = mysqli_query($con,"SELECT * FROM notetypes");
                        ...
                        while($res=mysqli_fetch_assoc($select)){
                            ...
                            <tr>
                                ...
                                ?></td>
                                <td>
                                <a href="add_type.php?edittype=<?php echo $res['ID']; ?>" class="icon"><img src="../images/icons/edit.png"></a>
                                <a href="manage-type.php?edittype=<?php echo $res['ID']; ?>" class="icon"><img src="../images/icons/delete.png"></a>
                            </td>
