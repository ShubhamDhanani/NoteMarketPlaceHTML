...
$textg="";
   ...
   if(isset($_POST['submit'])){
    ...
    $mail->send();
    $textg= 'Your Account Created Successfully , pls check your mail inbox for verification';
        }
        else{
            $textr="Not inserted your entry";
        }
           }
           else{
               $textr= "password is not matched";
           }
       }
   }
?>
            ...
            <div class="wrap-login">
                ...
                <form class="login-form" method="post" action="<?php echo htmlentities($_SERVER['PHP_SELF']
                    ...
                    <div class="signup-heading">
                        ...
                        <small id="signup-help" class="form-text text-muted text-center">
                            <p><?php echo $textg;?></p>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputfname" placeholder="Enter your first name" name="fname" pattern="[a-zA-Z]{3,}" title="At least three letters Required and all character must be alphabets" required>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputlname">Last Name *</label>
                        <input type="text" class="form-control" id="exampleInputlname" placeholder="Enter your last name" name="lname" pattern="[a-zA-Z]{3,}" title="At least three letters Required and all character must be alphabets" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group m-bottom-30">
                        ...
                        <div class="inputContainer">
                            <input type="password" id="confirm-password-field" class="form-control" placeholder="Re-enter your Password" name="cpass" pattern="(?=^.{6,24}$)((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z])(?=.*[0-9]).*$" title="Password shoud have atlest one capital,small,special character,number and 6 to 24 character long" required>
