    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 work_content">
                ...
                <div class="work_btn">
                    <a href="search.php"><button type="bustton" class="btn btn-primary work_btn" id="btn1"><span>Download</span></button></a>
                </div>
            </div>
            <div class="col-md-6 work_content">
                <div class="logo">
                ...
                <div class="work_btn">
                    <a href="<?php 
                                ...
                                ?>"><button type="button" class="btn btn-primary work_btn" id="btn2"><span>Sell Book</span></button></a>
                </div>
            </div>
        </div>
    </div>
