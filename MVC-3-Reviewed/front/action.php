...
if(isset($_POST['action'])){
    $sql = 'SELECT sellernotes.* ,AVG(Ratings) AS avgratings FROM sellernotes LEFT JOIN sellernotesreviews ON sellernotesreviews.NoteID=sellernotes.ID  GROUP BY sellernotes.ID HAVING sellernotes.Status=9 and sellernotes.IsActive=1';
    ...
    $sql .=" order by sellernotes.PublishedDate DESC";
}
            ...
            <div class="notes card" style="margin-top:20px;">
                <div class="card-img-top">
                    ...
                    if($result['DisplayPicture']==""){
                        ?>
                    <img src="../images/note/example.jpg" alt="note image" class="note-img img-fluid">
                    <?php
                    }
                    else{
                        ?>
                ...
                <div class="details card-body">
                    ...
                    $selquery = "select Name From countries where ID=$country AND IsActive=1";
                    ...
                    <?php
                            ...
                            ?>
                    <p class="card-text"><img src="../images/icons/flag.png"><?php echo $src;?> Users marked this note as inappropriate</p>
                    <div class="ratings">
                        <p>
