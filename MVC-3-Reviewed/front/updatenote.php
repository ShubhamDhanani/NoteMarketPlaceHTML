...
if(!isset($_SESSION['fname']) or $resu['SellerID']!==$_SESSION['id']){
...
if(isset($_POST['publish'])){
       ...
       $preview= $_FILES['preview'];
        ...
        if($updatequery){
            ...
            $mail->Subject = "$seller sent his note for review"; //subject line of email
...
?>
    ...
    <div class="container form-wrap">
        <form method="post" enctype="multipart/form-data" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="sellfor" id="inlineRadio1" value="5" required <?php if($resu['IsPaid']==5){echo "checked"; } ?>>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="prices" placeholder="Enter your price" name="price" required value="<?php echo $resu['SellingPrice']; ?>">
                        </div>
                    </div>
                </div>
                <div class="form-group col-md-6">
            ...
            <button type="submit" class="btn btn-primary" id="submit-btn-user" name="save" disabled>SAVE</button>
            <button type="submit" class="btn btn-primary" id="submit-btn-user" name="publish" onclick="return confirm('Do You Want to Publish This Book?')">Publish</button>
