...
$textg="";
   if(isset($_POST['submit'])){
    ...
    $mail->Subject = "NotesMarketPlace Account Temp Password Generation";       //subject line of email
    ...
    $mail->send();
           ...
           $textg="New Password Generation Link sent on your email";
            ...
            <div class="wrap-login">
                ...
                <form class="login-form" method="post" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>">
                    <div class="heading">
                       ...
                       <span id="signup-help" class="form-text text-center" style="color:green;text-align:center;"><?php echo $textg; ?></span>
                        
                    </div>
                    <div class="form-group m-bottom-30">
                        <label for="exampleInputEmail1">Email </label><span style="color:red;"><?php echo $textr; ?></span>
