                ...
                <table class="table table-hover table-responsive table1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="../php/approve.php?noteid=<?php echo $res['ID'] ?>" type="button" class="btn btn-primary green_btn" onclick="return confirm('If you approve the notes – System will publish the notes over portal. Please press ok to continue.')">Approve</a></td>
